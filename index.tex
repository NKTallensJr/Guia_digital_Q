...
\hypersetup{
  ...
  pdfauthor={Newton Krüger Tallens Junior},
  pdflang={pt},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, colback=white, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, toprule=.15mm, titlerule=0mm, arc=.35mm, toptitle=1mm, bottomrule=.15mm, breakable, left=2mm, opacityback=0, rightrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, coltitle=black]

Reforça uma ação.

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Cuidado}, colback=white, opacitybacktitle=0.6, colframe=quarto-callout-caution-color-frame, toprule=.15mm, titlerule=0mm, arc=.35mm, toptitle=1mm, bottomrule=.15mm, breakable, left=2mm, opacityback=0, rightrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-caution-color!10!white, leftrule=.75mm, coltitle=black]

Alerta sobe uma informação importante.

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Aviso}, colback=white, opacitybacktitle=0.6, colframe=quarto-callout-warning-color-frame, toprule=.15mm, titlerule=0mm, arc=.35mm, toptitle=1mm, bottomrule=.15mm, breakable, left=2mm, opacityback=0, rightrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, coltitle=black]

Avisa sobe uma informação crítica.

\end{tcolorbox}

\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Alerta}, colback=white, opacitybacktitle=0.6, colframe=quarto-callout-important-color-frame, toprule=.15mm, titlerule=0mm, arc=.35mm, toptitle=1mm, bottomrule=.15mm, breakable, left=2mm, opacityback=0, rightrule=.15mm, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, leftrule=.75mm, coltitle=black]
