...
Após o conhecimento dos objetivos, benefícios e restrições a medição de desempenho no setor público, a página seguinte sintetiza o conteúdo desta primeira parte do guia e na sequência inicia-se a fundamentação necessária para a construção de indicadores de desempenho para as instituições do setor público.
:::
